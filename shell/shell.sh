...
docker run -v /staging3/fanyucai/waste_water/Freyja-data/:/reference \
  -v /staging3/fanyucai/waste_water/Freyja_out:/outdir/ \
  -v /staging3/fanyucai/waste_water/outdir2:/raw_data/ \
  waste_water sh -c "activate freyja-env && freyja aggregate /out/ --output /outdir/test.aggregated-filename.tsv && freyja plot /outdir/test.aggregated-filename.tsv --output pdf"


freyja plot [aggregated-filename-tsv] --output