...
# Translation table for pangolin and WHO names of variants https://covariants.org/
pangolin2WHO = {'C.37':'Lambda','B.1.1.7': 'Alpha', 'B.1.351': 'Beta', 'P.1': 'Gamma', 'B.1.427': 'Epsilon', 'B.1.429': 'Epsilon',
                ...
                'BA.2.75':'BA.2.75', 'BA.4.6':'BA.4.6','BA.2.12.1':'BA.2.12.1','EG.5.1':'EG.5.1','CH.1.1':'CH.1.1',
                'BF.7':'BF.7', 'BQ.1':'BQ.1', 'BQ.1.1':'BQ.1.1','XBB':'XBB','XBB.1.5':'XBB.1.5','XBB.1.16':'XBB.1.16','XBB.1.9':'XBB.1.9','XBB.2.3':'XBB.2.3',
